...
class nginx (
  ...
  Variant[Integer,String] $grpc_read_timeout                 = '60',
  Variant[Integer,String] $grpc_connect_timeout              = '60',
  Array $grpc_set_header                                     = [],
  Array $grpc_hide_header                                    = [],
  Array $grpc_pass_header                                    = [],
  Nginx::Size $grpc_buffer_size                              = '8k',
