...
define nginx::resource::location (
  ...
  Variant[Integer,String] $grpc_read_timeout           = $nginx::grpc_read_timeout,
  Variant[Integer,String] $grpc_connect_timeout        = $nginx::grpc_connect_timeout,
  Array $grpc_set_header                               = $nginx::grpc_set_header,
  Array $grpc_hide_header                              = $nginx::grpc_hide_header,
  Array $grpc_pass_header                              = $nginx::grpc_pass_header,
  Nginx::Size $grpc_buffer_size                        = $nginx::grpc_buffer_size,
